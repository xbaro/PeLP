 ...
 */
package edu.uoc.pelp.test.services;
...
import edu.uoc.pelp.test.bussines.BussinesTests;
import edu.uoc.pelp.test.bussines.LocalUOCPelpBussinesImpl;
 ...
 * @author Xavier Baró
 */
public class Services_NormalWorkflow {
     ...
     *
     * admin: Administrator for the PeLP platform pra1: Main teacher for all
     * classrooms for subjects 05.062 and 05.073 for semester 20121 teacher1:
     * Teacher of the classroom 1 of subject 05.062 semester 20121 teacher2:
     * Teacher of the classroom 2 of subject 05.073 semester 20121 student1:
     * Student in the classroom 1 of subject 05.062 and classroom 1 of subject
     * 05.073 semester 20121 student2: Student in the classroom 1 of subject
     * 05.062 and classroom 2 of subject 05.073 semester 20121 student3: Student
     * in the classroom 1 of subject 05.062 and classroom 2 of subject 05.073
     * semester 20121
     */
    public Services_NormalWorkflow() {
         try {
    ...
    public void testCorrectWorkflow() {
        try {
            ...
            _bussines.setCampusSession("admin");
            
            userInfo=_bussines.getUserInformation();
            
            _bussines.setCampusSession("teacher1");
            
            userInfo=_bussines.getUserInformation();
            
            _bussines.setCampusSession("teacher2");
            ...
            /*
             * // An administrator log in and prepare the subject to be used by the
             * platform _campusConnection.setProfile("admin"); prepareSubject();
             *
             * // Once the subject is active, a teacher log in and add the
             * activities for the subject _campusConnection.setProfile("teacher1");
             * addActivities();
             *
             * // Now is all prepared for students.
             * _campusConnection.setProfile("student1"); addDeliversStudent1();
             * _campusConnection.setProfile("student2"); addDeliversStudent2();
             * _campusConnection.setProfile("student3"); addDeliversStudent3();
             *
             * // The teacher from the main classroom can see all the delivers
             * _campusConnection.setProfile("teacher1"); checkDelivers1();
             *
             * // The teacher from the laboratory only the delivers from students 2
             * and 3 _campusConnection.setProfile("teacher2"); checkDelivers2();
             */
        } catch (InvalidSessionException ex) {
            Logger.getLogger(Services_NormalWorkflow.class.getName()).log(Level.SEVERE, null, ex);
    ...
    /**
     * Create dummy delivers of the current user to a certain activity. It shows
     * the process of subject and activity selection, which may be done using
     * the web GUI.
     *
     ...
     * @param subject Subject to be selected from available
     * @param activity Activity to to be selected from available activities
     * @param numTotalDelivers Total number of delivers in this class (assuming
     * one class per user and subject)
     * @param numTotalStudents Total number of students in this class (assuming
     * one class per user and subject)
     */
