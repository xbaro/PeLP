...
class MoodleConsumer(BaseConsumer):
    ...
    def create_user(self, username: str, email: str) -> User:
        ...
        first_name = self.request.get_param('lis_person_name_given')
        last_name = self.request.get_param('lis_person_name_family')
    ...
    def create_user_profile(self, user: User):
        profile = LTIProfile.objects.create(
            ...
            ext_user_username=self.request.get_param('ext_user_username'),
    ...
    def update_user_profile(self, user: User):
        ...
        profile.ext_user_username = self.request.get_param('ext_user_username')
