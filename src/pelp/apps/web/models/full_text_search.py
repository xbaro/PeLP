"""
    Code adapted from: https://github.com/confirm/django-fulltext-search/blob/develop/django_fulltext_search.py
"""
...
class SearchQuerySet(models.query.QuerySet):
    ...
    def get_query_set(self, query, columns, mode):
        ...
        return self.extra(where=[where_expression], params=[query]).extra(select={'search_score': where_expression % query})
