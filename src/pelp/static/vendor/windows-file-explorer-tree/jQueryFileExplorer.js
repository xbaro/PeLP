(function ($) {
    ...
    FolderNode.prototype.GetChildren = function (callback) {
        ...
        this.headers = this.headers || this.tree.headers;
        this.fileOpenCallback = this.fileOpenCallback || this.tree.fileOpenCallback;
			...
			$.each(children,function(index,child){
                ...
                label.off("click").on("click", function (e) {
					...
					if(data.isFolder)
					{
                        ...
                        newNode.headers = newNode.headers || $this.headers;
                        newNode.fileOpenCallback = newNode.fileOpenCallback || $this.fileOpenCallback;
					...
					else
					{
						if (typeof $this.fileScript=='function') {
                            ...
                            if($this.fileOpenCallback != null) {
                                $.get($this.fileScript+"?path="+data.path, function(file_url) {
                                    $.get(file_url, $this.fileOpenCallback);
                                });
                            } else {
    ...
    FileExplorer = function (options) {
        ...
        var tree = new FolderTree({
            ...
            fileOpenCallback: options.fileOpenCallback,
